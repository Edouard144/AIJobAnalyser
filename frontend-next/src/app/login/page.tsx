...
import { Crosshair, Eye, EyeOff, Mail, Lock, User, ArrowLeft } from 'lucide-react';
...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex">
      {/* Left Side - Content/Marketing Zone (Green/Brand Side) */}
      <motion.div
        initial={{ x: 0 }}
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center justify-center w-full p-12">
          ...
          >
            ...
            <p className="text-white/80 text-lg">Sign in to continue finding your best candidates</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="relative">
              ...
              <Input
                ...
                className="pl-10 h-12 bg-muted/30 rounded-lg border-border focus:border-primary"
                error={errors.email}
              />
            </div>

            {/* Password - Icon-lead label */}
            <div className="relative">
              <div className="absolute left-3 top-1/2 -translate-y-1/2 z-10">
