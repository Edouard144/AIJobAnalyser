...
export const AIChatBubble = () => {
  ...
  const [msgs, setMsgs] = useState<Msg[]>([
    { id: 1, from: 'ai', text: "Hi! I'm your AI hiring assistant. Ask me anything about your candidates or jobs." },
  ]);
  ...
  const send = (text: string) => {
    ...
    setTimeout(() => {
      const reply: Msg = {
        id: Date.now() + 1,
        from: 'ai',
        text: "Based on your data, **Aiden Okonkwo** is your top match at 94% for Senior Backend Engineer. Strong system design, AWS expertise, and 8 years of Node.js experience. Would you like me to schedule an interview?",
      };
      setMsgs(m => [...m, reply]);
      setTyping(false);
    }, 1400);
